...
*/
object AffineWhetstone {

  private val e1: Array[AffineFloat] = Array.fill(4){0.0}
  private var routine = 0
  private val x100 = 100
  
  private var t =  AffineFloat(0.49999975)
  private val t0 = t        
  private val t1 = AffineFloat(0.50000025)
	private val t2 = AffineFloat(2.0)
  ...
  private var x = AffineFloat(0.0)
  private var y = AffineFloat(0.0)
  private var z = AffineFloat(0.0)
  ...
  private def pa(e: Array[AffineFloat], t: AffineFloat, t2: AffineFloat) {
    for(j <- 0 until 6) {
      e1(0) = (e1(0) + e1(1) + e1(2) - e1(3)) * t
		  e1(1) = (e1(0) + e1(1) - e1(2) + e1(3)) * t
			e1(2) = (e1(0) - e1(1) + e1(2) + e1(3)) * t
  ...
  private def p3(t: AffineFloat, t1: AffineFloat, t2: AffineFloat) {
    x = y
    y = z
    x = t * (x + y)
    y = t1 * (x + y)
  ...
  def po(e1: Array[AffineFloat], j: Int, k: Int, l: Int) {
    e1(j) = e1(k)
    e1(k) = e1(l)
    e1(l) = e1(j)
    return
