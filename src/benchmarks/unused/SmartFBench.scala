...
object SmartFBench {
  ...
  val clear_aperture = SmartFloat(4.0)
  var aberr_lspher = SmartFloat(0.0)
  var aberr_osc = SmartFloat(0.0)
  var aberr_lchrom = SmartFloat(0.0)
  var max_lspher = SmartFloat(0.0)
  var max_osc = SmartFloat(0.0)
  var max_lchrom = SmartFloat(0.0)

  var radius_of_curvature = SmartFloat(0.0)
  var object_distance = SmartFloat(0.0)
  var ray_height = SmartFloat(0.0)
  var axis_slope_angle = SmartFloat(0.0)
  var from_index = SmartFloat(0.0)
  var to_index = SmartFloat(0.0)

  val spectral_line = Array.fill(9){SmartFloat(0.0)}
  val s = Array.fill(max_surfaces, 5){SmartFloat(0.0)}
  val testcase: Array[Array[SmartFloat]] = Array(
        Array(27.05, 1.5137, 63.6, 0.52),
        Array(-16.68, 1, 0, 0.138),
        Array(-16.68, 1.6164, 36.7, 0.38),
        Array(-78.1, 1, 0, 0));

  var od_sa = Array.fill(2, 2){SmartFloat(0.0)}
  ...
  */
  ...
  def cot(x: SmartFloat): SmartFloat = 1.0 / tan(x)
  ...
  def trace_line(line: Int, ray_h: SmartFloat) = {
    var i = 0
  ...
  def transit_surface: Unit = {
    var iang,     /* Incidence angle */
        ...
        old_axis_slope_angle, sagitta = SmartFloat(0.0)
  ...
  def run(niter: Int): Long = {
    ...
    //Date    Now;
    var  time = 0L
    var  od_cline, od_fline = SmartFloat(0.0)
    var runtime = SmartFloat(0.0)
